...
import com.crescer.exercicio01.StringUtils;
import com.crescer.exercicio01.Exercicio01;
...
public class Chat {
    ...
    private static final StringUtils STRING_UTILS = new Exercicio01();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula2.txt", "@Rafael Barreto"};
        }
